...
def plot_time_interconnect_and_intercepts_at_time(Time_Enquriey : Decimal, data_output_ordered : Data_Output_Storage_Ordered ,**kwargs):
    ...
    which has an interactive form using ipywidgets, py:func:`Wavefront_Interactive.spatial_interconnect_investigator_ui`.
...
def save_spatial_interconnect(Interface : Data_Interface_Storage,**kwargs):
    ...
    It is effectively :py:func:`Wavefront_Interactive.spatial_interconnect_investigator_ui`, however smoother as computation is not 'real-time'
